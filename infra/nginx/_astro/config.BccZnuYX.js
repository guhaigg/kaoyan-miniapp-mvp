...
navbar:
    ...
    links:
        ...
        - name: "账户中心"
          ...
          description: "用户注册与登录"
        - name: "接口文档"
          url: "https://api.gewujl.cloud/docs"
          icon: "material-symbols:book"
          description: "后端 API 文档"
          external: true
        - name: "管理员"
          url: "https://api.gewujl.cloud/admin/"
...
profile:
    ...
    links:
        - # 链接示例
            ...
            # 链接
            url: "https://github.com/guhaigg/kaoyan-miniapp-mvp"
...
announcement:
    ...
    title: "站点公告"
    # 公告内容
    content: "已切换 Twilight 模板风格，查询入口请点击导航“查询入口”。"
    # 允许用户关闭公告
    closable: true
    # 链接配置
    link:
...
`,A=Nr.load(Mr),Dr={Home:F.Home,Archive:F.Archive,Projects:F.Projects,Skills:F.Skills,Timeline:F.Timeline,Diary:F.Diary,Albums:F.Albums,Anime:F.Anime,About:F.About,Friends:F.Friends},he=n=>{if(typeof n=="string"){const i=Dr[n];if(i===void 0)throw new Error(`Unknown LinkPreset: ${n}`);return i}if(typeof n=="number")return n;const e=n.children?.map(he);return e?{...n,children:e}:n},Rr=n=>n.map(he);({...A.post,comment:A.post.comment.twikoo?{...A.post.comment,twikoo:{...A.post.comment.twikoo,lang:A.post.comment.twikoo.lang??A.site.lang}}:A.post.comment});const jr=A.site;A.umami.enabled,A.umami.apiKey,A.umami.baseUrl,A.umami.scripts;Rr(A.navbar.links);const Yr=A.sidebar;A.profile;A.announcement;A.footer;const Br=A.particle,Hr=A.musicPlayer,Pr=A.pio;export{F as L,Yr as a,Br as b,Hr as m,Pr as p,jr as s};
