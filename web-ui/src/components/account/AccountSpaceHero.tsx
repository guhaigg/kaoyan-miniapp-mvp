...
export function AccountSpaceHero({
  ...
  return (
    <section className="overflow-hidden rounded-[2.4rem] border border-sky-100 bg-white shadow-[0_34px_110px_rgba(122,147,192,0.2)]">
      <motion.div
        initial={{ opacity: 0, y: 18 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.45, ease: "easeOut" }}
        className="relative h-44 bg-[linear-gradient(135deg,#73d6ff_0%,#a3e2ff_20%,#ffd8e8_60%,#ff90c1_100%)]"
      >
      ...
      <div className="relative px-5 pb-6 md:px-8">
        <div className="-mt-12 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="flex items-end gap-4">
            <div className="flex h-24 w-24 items-center justify-center rounded-full border-[6px] border-white bg-[linear-gradient(135deg,#ffb8d6,#86dbff)] text-3xl font-black text-white shadow-[0_18px_44px_rgba(96,122,177,0.25)]">
